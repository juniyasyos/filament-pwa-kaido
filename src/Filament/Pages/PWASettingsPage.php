                        ...
                        Section::make(trans('filament-pwa::messages.sections.icons'))
                            ...
                            ->schema([
                                FileUpload::make('pwa_icons_72x72')
                                    ...
                                    ->columnSpan(2)
                                    ->helperText(config('filament-settings-hub.show_hint') ? 'setting("pwa_icons_72x72")' : null),
                                FileUpload::make('pwa_icons_96x96')
                                    ->acceptedFileTypes(['image/png'])
                                    ->label(trans('filament-pwa::messages.form.pwa_icons_96x96'))
                                    ->columnSpan(2)
                                    ->helperText(config('filament-settings-hub.show_hint') ? 'setting("pwa_icons_96x96")' : null),
                                FileUpload::make('pwa_icons_128x128')
                                    ->acceptedFileTypes(['image/png'])
                                    ->label(trans('filament-pwa::messages.form.pwa_icons_128x128'))
                                    ->columnSpan(2)
                                    ->helperText(config('filament-settings-hub.show_hint') ? 'setting("pwa_icons_128x128")' : null),
                                FileUpload::make('pwa_icons_144x144')
                                    ->acceptedFileTypes(['image/png'])
                                    ->label(trans('filament-pwa::messages.form.pwa_icons_144x144'))
                                    ->columnSpan(2)
                                    ->helperText(config('filament-settings-hub.show_hint') ? 'setting("pwa_icons_144x144")' : null),
                                FileUpload::make('pwa_icons_152x152')
                                    ->acceptedFileTypes(['image/png'])
                                    ->label(trans('filament-pwa::messages.form.pwa_icons_152x152'))
                                    ->columnSpan(2)
                                    ->helperText(config('filament-settings-hub.show_hint') ? 'setting("pwa_icons_152x152")' : null),
                                FileUpload::make('pwa_icons_192x192')
                                    ->acceptedFileTypes(['image/png'])
                                    ->label(trans('filament-pwa::messages.form.pwa_icons_192x192'))
                                    ->columnSpan(2)
                                    ->helperText(config('filament-settings-hub.show_hint') ? 'setting("pwa_icons_192x192")' : null),
                                FileUpload::make('pwa_icons_384x384')
                                    ->acceptedFileTypes(['image/png'])
                                    ->label(trans('filament-pwa::messages.form.pwa_icons_384x384'))
                                    ->columnSpan(2)
                                    ->helperText(config('filament-settings-hub.show_hint') ? 'setting("pwa_icons_384x384")' : null),
                                FileUpload::make('pwa_icons_512x512')
                                    ->acceptedFileTypes(['image/png'])
                                    ->label(trans('filament-pwa::messages.form.pwa_icons_512x512'))
                                    ->columnSpan(2)
                                    ->helperText(config('filament-settings-hub.show_hint') ? 'setting("pwa_icons_512x512")' : null),
                            ]),
